...
FREECIV_DATA_PATH="${FREECIV_DATA_PATH}:/home/pring/freeciv-web/freeciv/freeciv/build/data:/home/pring/freeciv-web/freeciv/freeciv/build/../data"
export FREECIV_DATA_PATH

for ruleset in $rulesets; do
  echo "Loading $ruleset"
  /home/pring/freeciv-web/freeciv/freeciv/build/tools/manual/freeciv-manual -r $ruleset || exit 1
done
